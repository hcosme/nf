...
<?php //dd($dados['gerente']);?>
            ...
            <!--     <div class="form-group col-md-2">
                ...
                <input  type="submit" class="form-control form-control-md btn btn-secondary" value="Filtrar">
                    ...
                    <label for="exampleInputEmail1"><b style="color: white">.</b></label>
                    <a href="https://gestaoderecursos.com/exportacao/prazorj.php" ><input  type="button" class="form-control form-control-md btn btn-secondary" value="Baixar excel"></a>
                </div>
...
<div class="row">
          ...
          <div class="col-lg-3 col-4">
            ...
            <div class="small-box bg-secondary">
              ...
              <a href="./prazo_rj?status=VENCE EM 6H" class="small-box-footer"> <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-4">
            ...
            <div class="small-box bg-warning">
              ...
              <a href="./prazo_rj?status=VENCE EM 3H" class="small-box-footer"> <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-4">
            ...
            <div class="small-box bg-warning">
              ...
              <a href="./prazo_rj?status=VENCE EM 2H" class="small-box-footer"> <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
         ...
         <!-- ./col -->
          <div class="col-lg-3 col-4">
            ...
            <div class="small-box bg-danger">
              ...
              <a href="./prazo_rj?status=VENCE EM 1H" class="small-box-footer"> <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
                </div>
