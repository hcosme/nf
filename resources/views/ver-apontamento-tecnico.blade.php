            ...
            <form role="form" method="post" action="./editar_apontamento_tecnico_atualizar">
              ...
              <div class="row">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <select name="status" class="form-control form-control-sm" value="" readonly>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" class="form-control form-control-sm" name="data_alteracao" style="background:#" value="<?php echo $dados['dados'][0]->data_apontamento;?>" readonly="">
                    </div>
                    <div class="form-group col-md-4">
                        <label for="exampleInputEmail1">Login Alteração:</label>
                        <input type="text" class="form-control form-control-sm" name="login_alteracao" style="background:#" value="<?php echo $dados['dados'][0]->login_apontamento;?>" readonly="">
                    </div>
              </div><br>
...
<div class="box-footer">
                ...
                <a href="./alterar_presenca"><button type="button" class="btn btn-secondary">Retornar</button> </a>
              </div><br>
            </form>
          </div>
          <!-- /.box -->
