...
<div class="callout callout-secondary">
   ...
   <div class="in" id="collapseExample4">
      <form action="./prazo_sla" method="get">
         <div class="row">
            ...
            <div class="form-group col-md-2">
               ...
               <select class="form-control form-control-md" name="vencimento_em">
                  <?php if(isset($_GET['vencimento_em'])) {
                     echo '<option value="'.$_GET['vencimento_em'].'">'.$_GET['vencimento_em'].'</option>';
                     };?>
                  <option value="TODOS">TODOS</option>
                  <?php
                     foreach ($dados['vencimento_em'] as $ger) {
                         echo '
