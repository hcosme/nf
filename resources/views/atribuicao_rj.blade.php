...
<div class="row">
        ...
        <div class="col-lg-4 col-6">
            ...
            <div class="small-box bg-info">
              <div class="inner">
                <h3 style="color:">{{ $dados['atribuido'][0]->QTD }}</h3>
              ...
              <a href="./atribuicao_rj?status='ATRIBUIDO'" class="small-box-footer"> <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-4 col-6">
            ...
            <div class="small-box bg-info">
              <div class="inner">
                 <h3 style="color:">{{ $dados['n_atribuido'][0]->QTD }}</h3>
              ...
              <a href="./atribuicao_rj?status='N_ATRIBUIDO'" class="small-box-footer"> <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-4 col-6">
            ...
            <div class="small-box bg-info">
              ...
              <a href="./atribuicao_rj" class="small-box-footer"> <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
                </div>
 ...
 <table id="tbl_atribuicao" class="table table-striped table-sm table-bordered dataTable">
   <thead>
      <tr class="bg-light text-center py-0 align-middle">
        <th style=" background-color:#191970;color:white;width:200px" colspan="19"><center>[ATRIBUIÇÃO RJ] </th> 
        </tr>
      <tr class="bg-light text-center py-0 align-middle">
