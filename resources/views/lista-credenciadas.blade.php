        ...
        <table id="" class="table table-striped table-sm table-bordered dataTable">
            <thead>
                <tr class="bg-info text- py-0 align-middle">
                    <th style=" background-color:#;color:;width:120px"><center>Nome</th>
            ...
            <?php 
                ...
                foreach ($dados['dados'] as $gr) {
                    echo '<tr class="bg- text- py-0 align-middle">
                            ...
                            <td><center>
                                <a style="color:white" class="btn btn-success btn-xs" href="./lancar_presenca?credenciada='.$gr->credenciadas.'"><i class="fas fa-edit"></i>Lançar Presença</a>
                            </td>
                    ';
                }
            ?>
