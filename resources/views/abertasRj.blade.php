...
<h1 class="m-0 text-dark">[REPARO RJ]</h1>
@stop
...
<form action="./abertasRj" method="get">
     <div class="row">
...
<div class="row">
          <div class="col-md-2 col-sm-6 col-12">
           ...
           <div class="col-md-2 col-sm-6 col-12">
            <div class="info-box">
              ...
              <div class="info-box-content"><a href="./atribuicao_rj?STATUS_ATRIUICAO=ATRIBUIDO">
           ...
           <div class="col-md-2 col-sm-6 col-12">
            <div class="info-box">
              ...
              <div class="info-box-content"><a href="./atribuicao_rj?STATUS_ATRIUICAO=N_ATRIBUIDO">
          ...
          <!-- /.col -->
          <div class="col-md-2 col-sm- col-12">
            <div class="info-box">
            ...
            //    $ffa = $dados['visaoFFA'][0];
               ...
               echo '<tr class="bg- text-center py-0 align-middle">
                            ...
                            +$dados['faixasRTotal'][0]->D+$dados['faixasRTotal'][0]->E+$dados['faixasRTotal'][0]->F).'</td>
                             ...
                             <td style="background-color:;color:">100%</td>                            
   ...
   <table id="minhaTabçççela" class="table table-responsive table-sm table-bordered table-hover dataTable">
    <thead>
      ...
      <tr class="bg-light text-center py-0 align-middle">
        ...
        <th style=" background-color:#;color:black;width:140px"><center>Maior 96h</th>
        <th style=" background-color:#;color:black;width:140px"><center>Total</th>
        <th style=" background-color:#;color:black;width:140px"><center>% Resp. Area.</th>
      </tr>
    </thead>
    <tbody>
