      ...
      <h3>[INSTALAÇÃO 
        ...
        ?>
          ...
          <!--     <div class="small-box bg-gray">
              <div class="inner">
                 <h3>{{ $dados['abertasNoPrazo'][0]->qtd }}</h3>
          ...
          <!--      <div class="small-box bg-gray">
              <div class="inner">
                  <h3>{{ $dados['abertasVencidas'][0]->qtd }}</h3>
          ...
          <!--       <div class="small-box bg-gray">
              <div class="inner">
                 <h3>{{ $dados['encerradoNoPrazo'][0]->qtd }}</h3>
          ...
          <!--        <div class="small-box bg-gray">
              <div class="inner">
                  <h3>{{ $dados['encerradoVencidas'][0]->qtd }}</h3>
          ...
          <!--         <div class="small-box bg-gray">
              <div class="inner">
                 <h3>{{ $dados['pendenteVencidas'][0]->qtd }}</h3>
          ...
          <!--       <div class="small-box bg-gray">
              <div class="inner">
                  <h3>{{ $dados['pendenteNoPrazo'][0]->qtd }}</h3>
      ...
      <h3>[MUDANÇA   <?php 
        ...
        ?>] </h3><p>
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-secondary">
              <div class="inner">
                <h3>{{ $dados['mudbacklogProducao'][0]->qtd }}</h3>
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
              <div class="inner">
                 <h3>{{ $dados['mudnaoIniciado'][0]->qtd }}</h3>
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
              <div class="inner">
                 <h3>{{ $dados['mudcancelada'][0]->qtd }}</h3>
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-teal">
              <div class="inner">
                <h3>{{ round(100-(($dados['mudpendente'][0]->qtd)/($dados['mudproducao'][0]->qtd+$dados['mudpendente'][0]->qtd)*100),2).'%' }}</h3>
      ...
      <h3>[DESCONEXÃO   <?php 
        ...
        ?>] </h3><p>
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-secondary">
              <div class="inner">
                <h3>{{ $dados['descbacklogProducao'][0]->qtd }}</h3>
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
              <div class="inner">
                 <h3>{{ $dados['descnaoIniciado'][0]->qtd }}</h3>
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-olive">
              <div class="inner">
                  <h3>{{ $dados['desciniciado'][0]->qtd }}</h3>
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-teal">
              <div class="inner">
               <h3>{{ $dados['descproducao'][0]->qtd }}</h3>
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-secondary">
              <div class="inner">
               <h3>{{ $dados['descpendente'][0]->qtd }}</h3>
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
              <div class="inner">
                 <h3>{{ $dados['desccancelada'][0]->qtd }}</h3>
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-olive">
              <div class="inner">
                  <h3>{{ $dados['descsuspenso'][0]->qtd }}</h3>
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-teal">
              <div class="inner">
                <h3>{{ round(100-(($dados['descpendente'][0]->qtd)/($dados['descproducao'][0]->qtd+$dados['descpendente'][0]->qtd)*100),2).'%' }}</h3>
                    ...
                    <?php
                      ...
                      foreach ($dados['rankingPendenciamentoPendente'] as $tecnicos) {
                        echo 
                          '<tr align ="">
                            <td>'.$num++.'</td>
                            <td>'.substr($tecnicos->razao_nao_executado_1,0,20).'...</td>
                            <td align="center"><span class="badge bg-success">'.$tecnicos->qtd.'</span></td>
                          </tr>';
                      }
