    ...
    <div class="row">
        ...
        <div class="col-lg-12">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" method="post" action="./editarPos">
              <div class="box-body">
               ...
               <h5 style="color:#;"><b>Dados da Alteração</b></h5>
                ...
                <div class="row">
                   ...
                   <div class="form-group col-md-3">
                        ...
                        <input type="text" class="form-control form-control-sm" name="operador" style="background:#e0e0eb" value="<?php  echo auth()->user()->name;?>" readonly="">
                    </div>
                       
                   <div class="form-group col-md-2">
                        <label for="exampleInputEmail1">Parametros estão OK?</label>
                        <select name="parametro" class="form-control form-control-sm">
                   ...
                   <div class="form-group col-md-2">
                        ...
                        <select name="com_sucesso" class="form-control form-control-sm">
                            <option value="NÃO">NÃO</option>
                            <option value="SIM">SIM</option>
                        </select>
                    </div>
                   ...
                   <div class="form-group col-md-2">
                        ...
                        <select name="deixou_telefone_contato" class="form-control form-control-sm">
                            <option value="NÃO">NÃO</option>
                            <option value="SIM">SIM</option>
                        </select>
                    </div>
                        ...
                        <select name="proativo" class="form-control form-control-sm">
                            <option value="NÃO">NÃO</option>
                            <option value="SIM">SIM</option>
                        </select>
                    </div>
                       <div class="form-group col-md-2">
                        <label for="exampleInputEmail1">Número proativo?</label>
                          <input type="text" class="form-control form-control-sm" name="n_proativo" style="background:#fff" value="" >
                    </div>
