    ...
    <div class="row">
        ...
        <div class="col-lg-12">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" method="post" action="./editar_tecnico_novo">
              <div class="box-body">
              ...
              <div class="row">
                   ...
                   <div class="form-group col-md-3">
                     ...
                     <div class="form-group col-md-3">
                        ...
                        <input type="text" class="form-control form-control-sm" name="credenciada" style="background:#" value="<?php echo  $dados['dados'][0]->credenciadas;?>" readonly="">
                    </div>
                
                    <div class="form-group col-md-4">
                        <label for="exampleInputEmail1">Nome Técnico:</label>
                        <input type="text" class="form-control form-control-sm" name="tecnico" style="background:#" value="<?php echo  $dados['dados'][0]->tecnicos;?>" required>
                    </div>
                    <div class="form-group col-md-4">
                        <label for="exampleInputEmail1">Matrícula:</label>
                        <input type="text" class="form-control form-control-sm" name="matricula" style="background:#" value="<?php echo  $dados['dados'][0]->matricula;?>" required>
                    </div>
                    <div class="form-group col-md-4">
                        <label for="exampleInputEmail1">Matricula TLP:</label>
                        <input type="text" class="form-control form-control-sm" name="matricula_alp" style="background:#" value="<?php echo  $dados['dados'][0]->matricula_alp;?>" required>
                    </div>
                    <div class="form-group col-md-4">
                        <label for="exampleInputEmail1">Placa:</label>
                        <input type="text" class="form-control form-control-sm" name="placa" style="background:#" value="<?php echo  $dados['dados'][0]->placa;?>" required>
                    </div>
                    
                     <div class="form-group col-md-4">
                        <label for="exampleInputEmail1">Telefone:</label>
                        <input type="text" class="form-control form-control-sm" name="telefone" style="background:#" value="<?php echo  $dados['dados'][0]->telefone;?>" required>
                    </div>
                    
                    
                    <div class="form-group col-md-4">
                        <label for="exampleInputEmail1">Nome Controlador:</label>
                        <input type="text" class="form-control form-control-sm" name="controlador" style="background:#" value="<?php echo  $dados['dados'][0]->controlador;?>" required>
                    </div>
                       ...
                       <div class="form-group col-md-2">
                        ...
                        <select name="atividade" class="form-control form-control-sm" value="" >
                             <?php 
                            echo '<option value="'.$dados['dados'][0]->atividade.'">'.$dados['dados'][0]->atividade.' | Atual</option>';
                            ?>
                   ...
                   <div class="form-group col-md-2">
                        ...
                        <select name="skill" class="form-control form-control-sm" value="" >
                              <?php 
                            echo '<option value="'.$dados['dados'][0]->skill.'">'.$dados['dados'][0]->skill.' | Atual</option>';
                            ?>
                        ...
                        <select name="gerente" class="form-control form-control-sm" value="">
                            <?php 
                            echo '<option value="'.$dados['dados'][0]->gerente.'">'.$dados['dados'][0]->gerente.' | Atual</option>';
                      ...
                      <div class="form-group col-md-4">
                        ...
                        <select name="coordenador" class="form-control form-control-sm" value="">
                            <?php 
                            echo '<option value="'.$dados['dados'][0]->coordenador.'">'.$dados['dados'][0]->coordenador.' | Atual</option>';
                        ...
                        <select name="supervisor" class="form-control form-control-sm" value="">
                            <?php 
                            echo '<option value="'.$dados['dados'][0]->supervisor.'">'.$dados['dados'][0]->supervisor.' | Atual</option>';
                        ...
                        <select name="fiscal" class="form-control form-control-sm" value="">
                            <?php 
                            echo '<option value="'.$dados['dados'][0]->fiscal.'">'.$dados['dados'][0]->fiscal.' | Atual</option>';
