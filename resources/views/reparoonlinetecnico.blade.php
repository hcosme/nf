...
<form action="./reparo_online_tecnico?inicio=<?php echo $_GET['inicio'];?>&fim=<?php echo $_GET['fim'];?>&presenca=1&gerente=<?php echo $_GET['gerente'];?>&coordenador=<?php echo $_GET['coordenador'];?>&supervisor=<?php echo $_GET['supervisor'];?>&tecnologia=<?php echo $_GET['tecnologia'];?>&tipo=<?php echo $_GET['tipo'];?>&situacao=<?php echo $_GET['situacao'];?>" method="get">
     <div class="row">
 ...
 <table id="minhaTabela2" class="table table-striped table-sm table-bordered dataTable">
    <thead>
      <tr class="bg-light text-center py-0 align-middle">
        <th style=" background-color:#483D8B;color:white;width:200px" colspan="19"><center>[REPARO - TÉCNICOS <?php 
      ...
      <tr class="bg-light text-center py-0 align-middle">
        ...
        <th style=" background-color:#191970;color:white;width:80px"><center>Tipo</th>
