    ...
    <div class="row">
        ...
        <div class="col-lg-12">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
              <form role="form" method="post" action="./editar_cq">
              <div class="box-body">
              ...
              <hr>      <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select name="cracha" class="form-control form-control-sm" value="" >
                            <option value="<?php echo $dados['dados'][0]->cracha?>"><?php echo $dados['dados'][0]->cracha?> - ATUAL</option>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select name="cordial" class="form-control form-control-sm" value="" >
                          <option value="<?php echo $dados['dados'][0]->cordial?>"><?php echo $dados['dados'][0]->cordial?> - ATUAL</option>
                            <option value="SIM">SIM</option>
                            <option value="NÃO">NÃO</option>
                          </select>
                        </div>          
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select name="trajeto" class="form-control form-control-sm" value="" >
                            <option value="<?php echo $dados['dados'][0]->trajeto?>"><?php echo $dados['dados'][0]->trajeto?> - ATUAL</option>
                            <option value="SIM">SIM</option>
                            <option value="NÃO">NÃO</option>
                        </select>
                        </div>
                    <div class="form-group col-md-6">
                        ...
                        <select name="cabeamento" class="form-control form-control-sm" value="" >
                            <option value="<?php echo $dados['dados'][0]->cabeamento?>"><?php echo $dados['dados'][0]->cabeamento?> - ATUAL</option>
                            <option value="SIM">SIM</option>
                            <option value="NÃO">NÃO</option>
                        </select>
                        </div>          
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select name="funcionamento" class="form-control form-control-sm" value="" >
                            <option value="<?php echo $dados['dados'][0]->funcionamento?>"><?php echo $dados['dados'][0]->funcionamento?> - ATUAL</option>
                           <option value="SIM">SIM</option>
                            <option value="NÃO">NÃO</option>
                         </select>
                        </div>
                    <div class="form-group col-md-6">
                        ...
                        <select name="duvidas" class="form-control form-control-sm" value="" >
                            <option value="<?php echo $dados['dados'][0]->duvidas?>"><?php echo $dados['dados'][0]->duvidas?> - ATUAL</option>
                            <option value="SIM">SIM</option>
                            <option value="NÃO">NÃO</option>
                        </select>
                        </div>          
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select name="senha_wifi" class="form-control form-control-sm" value="" >
                            <option value="<?php echo $dados['dados'][0]->senha_wifi?>"><?php echo $dados['dados'][0]->senha_wifi?> - ATUAL</option>
                            <option value="SIM">SIM</option>
                            <option value="NÃO">NÃO</option>
                        </select>
                        </div>
                    <div class="form-group col-md-6">
                        ...
                        <select name="assinatura_digital" class="form-control form-control-sm" value="" >
                            <option value="<?php echo $dados['dados'][0]->assinatura_digital?>"><?php echo $dados['dados'][0]->assinatura_digital?> - ATUAL</option>
                            <option value="SIM">SIM</option>
                            <option value="NÃO">NÃO</option>
                        </select>
                        </div>          
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select name="numero_pessoal" class="form-control form-control-sm" value="" >
                            <option value="<?php echo $dados['dados'][0]->numero_pessoal?>"><?php echo $dados['dados'][0]->numero_pessoal?> - ATUAL</option>
                            <option value="SIM">SIM</option>
                            <option value="NÃO">NÃO</option>
                        </select>
                        </div>
                    <div class="form-group col-md-6">
                        ...
                        <select name="limpo" class="form-control form-control-sm" value="" >
                            <option value="<?php echo $dados['dados'][0]->limpo?>"><?php echo $dados['dados'][0]->limpo?> - ATUAL</option>
                            <option value="SIM">SIM</option>
                            <option value="NÃO">NÃO</option>
                        </select>
                        </div>          
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select name="danos" class="form-control form-control-sm" value="" >
                            <option value="<?php echo $dados['dados'][0]->danos?>"><?php echo $dados['dados'][0]->danos?> - ATUAL</option>
                            <option value="SIM">SIM</option>
                            <option value="NÃO">NÃO</option>
                        </select>
                        </div>
                    <div class="form-group col-md-6">
                        ...
                        <select name="avaliacao_servico" class="form-control form-control-sm" value="" >
                            <option value="<?php echo $dados['dados'][0]->avaliacao_servico?>"><?php echo $dados['dados'][0]->avaliacao_servico?> - ATUAL</option>
                            <option value="SIM">SIM</option>
                            <option value="NÃO">NÃO</option>
                        </select>
                        </div>          
                    <div class="form-group col-md-6">
                        ...
                        <select name="avaliacao_atendimento" class="form-control form-control-sm" value="" >
                            <option value="<?php echo $dados['dados'][0]->avaliacao_atendimento?>"><?php echo $dados['dados'][0]->avaliacao_atendimento?> - ATUAL</option>
                            <option value="SIM">SIM</option>
                            <option value="NÃO">NÃO</option>
                        </select>
                        </div>
                    <div class="form-group col-md-6">
                        ...
                        <select name="tecnico_controle_qualidade" class="form-control form-control-sm" value="" >
                            <option value="<?php echo $dados['dados'][0]->tecnico_controle_qualidade?>"><?php echo $dados['dados'][0]->tecnico_controle_qualidade?> - ATUAL</option>
                            <option value="SIM">SIM</option>
                            <option value="NÃO">NÃO</option>
                        </select>
                        </div>          
