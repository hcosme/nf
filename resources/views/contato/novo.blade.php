...
<!-- /.box-header -->
<!-- form start -->
<form role="form" method="post" action="./cadastrar_contato">
   <div class="box-body">
      {{ csrf_field()  }}
      <br>
      <div class="col-lg-12">
         ...
         <div class="row">
            <div class="form-group col-md-3">
               ...
               <input type="text" class="form-control form-control-sm" name="nome" style="background:#" placeholder="Exemplo preenchimento: 105.60" value="">
            </div>
            
            <div class="form-group col-md-3">
               <label for="exampleInputEmail1">Contato:</label>
               <input type="text" class="form-control form-control-sm" name="contato" style="background:#" placeholder="Exemplo preenchimento: 21999999999" value="">
            </div>
            
            <div class="form-group col-md-3">
               <label for="exampleInputEmail1">Mensagem:</label>
               <input type="text" class="form-control form-control-sm" name="motivo" style="background:#" placeholder="Coloque uma mensagem de no máximo 120 caracteres." value="">
            </div>
            <div class="form-group col-md-3">
