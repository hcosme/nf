    ...
    <div class="row">
        ...
        <div class="col-lg-12">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" method="post" action="./editar_brigada">
              <div class="box-body">
...
<br>
               <h5 style="color:#;"><b>Dados da tratamento</b></h5>
                  <hr>
  <div class="row">
<div class="card" style="width: 2rem;">
    </div>
<div class="card" style="width: 40rem;">
  <img class="card-img-top" src="<?php echo (asset('../storage/app/public/brigada/'.$dados['dados'][0]->antes));?>" style="width: 50rem;" alt="Card image cap">
  <div class="card-body">
    <p class="card-text">{{ $dados['dados'][0]->encontrado }}</p>
  </div>
</div>
<div class="card" style="width: 2rem;">
    </div>
<div class="card" style="width: 40rem;">
  <img class="card-img-top" src="<?php echo (asset('../storage/app/public/brigada/'.$dados['dados'][0]->antes));?>" alt="Card image cap">
  <div class="card-body">
    <p class="card-text">{{ $dados['dados'][0]->tratamento }}</p>
  </div>
  
</div>
 <div class="form-group col-md-6">
                        <label for="exampleInputEmail1">Login Correção:</label>
                        <input type="text" class="form-control form-control-sm" name="caixa" style="background:#" value="{{ $dados['dados'][0]->login_campo }}" readonly>
                    </div>
 <div class="form-group col-md-6">
                        <label for="exampleInputEmail1">Data Correção:</label>
                        <input type="text" class="form-control form-control-sm" name="caixa" style="background:#" value="{{ $dados['dados'][0]->data_correcao }}" readonly>
                    </div>
