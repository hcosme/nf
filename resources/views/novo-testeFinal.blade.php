    ...
    <div class="row">
        ...
        <div class="col-lg-12">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" method="post" action="./cadastrar-testefinal">
              <div class="box-body">
              ...
              <div class="row">
                    ...
                    <div class="form-group col-md-2">
                        ...
                        <input type="date" class="form-control form-control-sm" name="data" style="background:#" value="" required>
                    </div>
                    
                    <div class="form-group col-md-2">
                        <label for="exampleInputEmail1">Numero da Ordem:</label>
                        <input type="text" class="form-control form-control-sm" name="numero_ordem" style="background:#" value="" required>
                    </div>
                   ...
                   <div class="form-group col-md-2">
                        ...
                        <input type="text" class="form-control form-control-sm" name="tecnico" style="background:#" value="">
                    </div>
                    ...
                    <div class="form-group col-md-2">
                        ...
                        <input type="text" class="form-control form-control-sm" name="contato_cliente" style="background:#" value="">
                    </div>
