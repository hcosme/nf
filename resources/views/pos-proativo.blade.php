...
<form action="./pos-proativo" method="get">
      <div class="row">
...
<div class="row">
        ...
        <div class="col-lg-6 col-6">
            ...
            <div class="small-box bg-info">
              <div class="inner">
                <h3 style="color:">{{ $dados['despachar'][0]->QTD }}</h3>
              ...
              <a href="./pos-proativo?status=despachar" class="small-box-footer"> <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-6 col-6">
            ...
            <div class="small-box bg-info">
              <div class="inner">
                 <h3 style="color:">{{ $dados['despachado'][0]->QTD }}</h3>
              ...
              <a href="./pos-proativo?status=despachado" class="small-box-footer"> <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
 ...
 <table id="tbl_atribuicao" class="table table-striped table-sm table-bordered dataTable">
   <thead>
      <tr class="bg-light text-center py-0 align-middle">
        <th style=" background-color:#020E37;color:white;width:200px" colspan="19"><center>[Pós Despacho]</th> 
        </tr>
      <tr class="bg-light text-center py-0 align-middle">
    ...
    <tbody>
            <?php 
                ...
                foreach ($dados['pos'] as $gr) {
                    ...
                    <td> <a href="./editar-pos-despachar?id='.$gr->id.'"> '.$gr->data.'</td>
                    <td> <a href="./editar-pos-despachar?id='.$gr->id.'"> '.$gr->uf.'</td>
                    <td> <a href="./editar-pos-despachar?id='.$gr->id.'"> '.$gr->ordem.'</td>
                    <td> <a href="./editar-pos-despachar?id='.$gr->id.'"> '.$gr->tecnico.'</td>
                    <td> <a href="./editar-pos-despachar?id='.$gr->id.'"> '.$gr->tipo_atividade.'</td>
